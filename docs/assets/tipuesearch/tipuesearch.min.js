(function ($) {
    $.fn.tipuesearch = function (options) {
		// console.log(options) collection:r or python or statistics
        var set = $.extend(
            {
                ...
                if (d.length >= set.minimumLength) {
                    if (standard) {
                        ...
                        for (var i = 0; i < tipuesearch_in.pages.length; i++) {
							...
							var collection = tipuesearch_in.pages[i].collection;
                            for (var f = 0; f < d_w.length; f++) {
								
								// code to restrict search based on collections
								if (collection != set.collection){
									continue
								}
                                if (set.wholeWords) {
                                ...
                                if (tipuesearch_in.pages[i].url != null && tipuesearch_in.pages[i].url.search(pat) != -1) {
                                    score += 20;
                                }
                                if (score != 0) {
